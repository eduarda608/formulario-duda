...
if(isset($_POST['submit']))
{
    ...
    $genero = mysqli_real_escape_string($conexao, $sexo);
    ...
    $stmt = mysqli_prepare($conexao, "INSERT INTO usuarios (nome, email, telefone, sexo, data_nasc, cidade, estado, endereco) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
    mysqli_stmt_bind_param($stmt, "ssssssss", $nome, $email, $telefone, $genero, $data_nasc, $cidade, $estado, $endereco);
